...
namespace OgilvyOne.Common
{
    public class Encrypt
    {
        ...
        const string encrypt_key = "0g1lvyOneV1etN@m";
        const bool enable_encrypt = true;

        static public string Key
        {
            get { return encrypt_key; }
        }
        static public bool Enable
        {
            get { return enable_encrypt; }
        }
        ...
        static public string EncryptData(String strKey, String strData, Boolean setParam = false)
        {
            string strResult;		//Return Result
            ...
            if (setParam)
            {
                return strResult.Replace("=", "").Replace("/", "").Replace("+", "");
            }
        ...
        static public string DecryptData(String strKey, String strData, out bool decrypt_error)
        {
            decrypt_error = false;
            string strResult;
